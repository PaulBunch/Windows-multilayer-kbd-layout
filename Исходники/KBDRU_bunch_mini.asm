...
; kbdru_bunch_mini - based on the KBDRU (3.13) [FileVersion: 10.0.19041.1 (WinBuild.160101.0800)] layout, the first three layers of which have been minimally modified, and three more "universal" layers have been added.
...
vk2wchar2_7:
    vkrow7 VK_GRAVE     , CAPLOK                        , "ё" , "Ё" , NONE, NONE, NONE, NONE, NONE
	vkrow7 "1"          , 0                             , "1" , "!" , NONE, NONE, NONE, NONE, NONE
    vkrow7 "3"          , 0                             , "3" , "№" , NONE, NONE, NONE, NONE, NONE
    vkrow7 "4"          , 0                             , "4" , ";" , NONE, NONE, NONE, NONE, NONE
    vkrow7 "5"          , 0                             , "5" , "%" , NONE, NONE, NONE, NONE, NONE
    vkrow7 "7"          , 0                             , "7" , "?" , NONE, NONE, NONE, NONE, NONE
    vkrow7 "8"          , 0                             , "8" , "*" , NONE, "₽" , NONE, NONE, NONE  
    vkrow7 "9"          , 0                             , "9" , "(" , NONE, NONE, NONE, NONE, NONE
    vkrow7 "0"          , 0                             , "0" , ")" , NONE, NONE, NONE, NONE, NONE
    vkrow7 VK_EQUALS    , 0                             , "=" , "+" , NONE, NONE, NONE, NONE, NONE
    vkrow7 "Q"          , CAPLOK                        , "б" , "Б" , NONE, NONE, NONE, NONE, "±"  ; й
    vkrow7 "W"          , CAPLOK                        , "ц" , "Ц" , NONE, NONE, NONE, "@" , "°"
    vkrow7 "E"          , CAPLOK                        , "у" , "У" , NONE, NONE, NONE, "#" , "№"
    vkrow7 "R"          , CAPLOK                        , "к" , "К" , NONE, NONE, NONE, "^" , "$"
    vkrow7 "T"          , CAPLOK                        , "е" , "Е" , NONE, "ё" , "Ё" , "%" , "&"  
    vkrow7 "Y"          , CAPLOK                        , "н" , "Н" , NONE, NONE, NONE, "*" , "™"
    vkrow7 "U"          , CAPLOK                        , "г" , "Г" , NONE, NONE, NONE, "7" , "⋅"
    vkrow7 "I"          , CAPLOK                        , "ш" , "Ш" , NONE, NONE, NONE, "8" , "₽"
    vkrow7 "O"          , CAPLOK                        , "щ" , "Щ" , NONE, NONE, NONE, "9" , "€"
    vkrow7 "P"          , CAPLOK                        , "з" , "З" , NONE, NONE, NONE, "|" , "£"
    vkrow7 VK_LBRACKET  , CAPLOK                        , "х" , "Х" , NONE, NONE, NONE, "\" , "⌀"
    vkrow7 VK_RBRACKET  , CAPLOK                        , "й" , "Й" , NONE, NONE, NONE, NONE, "∞"  ; ъ
    vkrow7 "A"          , CAPLOK                        , "ф" , "Ф" , NONE, NONE, NONE, NONE, "`" 
    vkrow7 "S"          , CAPLOK                        , "ы" , "Ы" , NONE, NONE, NONE, "(" , "‐"
    vkrow7 "D"          , CAPLOK                        , "в" , "В" , NONE, NONE, NONE, ")" , '"'
    vkrow7 "F"          , CAPLOK                        , "а" , "А" , NONE, NONE, NONE, "[" , "?"
    vkrow7 "G"          , CAPLOK                        , "п" , "П" , NONE, NONE, NONE, "]" , "–"
    vkrow7 "H"          , CAPLOK                        , "р" , "Р" , NONE, NONE, NONE, "+" , "×"
    vkrow7 "J"          , CAPLOK                        , "о" , "О" , NONE, NONE, NONE, "4" , "!"
    vkrow7 "K"          , CAPLOK                        , "л" , "Л" , NONE, NONE, NONE, "5" , "'"
    vkrow7 "L"          , CAPLOK                        , "д" , "Д" , NONE, NONE, NONE, "6" , "—"
    vkrow7 VK_SEMICOLON , CAPLOK                        , "ж" , "Ж" , NONE, NONE, NONE, "-" , "~"
    vkrow7 VK_APOSTROPHE, CAPLOK                        , "э" , "Э" , NONE, NONE, NONE, "=" , "π"
    vkrow7 "Z"          , CAPLOK                        , "я" , "Я" , NONE, NONE, NONE, NONE, "§"
    vkrow7 "X"          , CAPLOK                        , "ч" , "Ч" , NONE, NONE, NONE, "<" , "„"
    vkrow7 "C"          , CAPLOK                        , "с" , "С" , NONE, NONE, NONE, ">" , "“"
    vkrow7 "V"          , CAPLOK                        , "м" , "М" , NONE, NONE, NONE, "{" , "«"
    vkrow7 "B"          , CAPLOK                        , "и" , "И" , NONE, "й" , "Й" , "}" , "»"  ; Эксперемент с буквой «й»
    vkrow7 "N"          , CAPLOK                        , "т" , "Т" , NONE, NONE, NONE, "0" , "®"
    vkrow7 "M"          , CAPLOK                        , "ь" , "Ь" , NONE, "ъ" , "Ъ" , "1" , "←" 
    vkrow7 VK_COMMA     , 0                             , "," , ";" , NONE, NONE, NONE, "2" , "→"  ; б
    vkrow7 VK_PERIOD    , 0                             , "." , ":" , NONE, NONE, NONE, "3" , "©"  ; ю
    vkrow7 VK_SLASH     , CAPLOK                        , "ю" , "Ю" , NONE, NONE, NONE, "/" , "÷"  ; .
    vkrow7 VK_SPACE     , 0                             , " " , " " , " " , " " , " " , " " , "_" 
    dw 0, 0, 7 dup 0
...
vk2wchar3_8:
    vkrow8 "2"          , 0                             , "2" , '"' , NONE, NONE, NONE, NONE, NONE, 0x00
    vkrow8 "6"          , 0                             , "6" , ":" , NONE, NONE, NONE, NONE, NONE, 0x1E
    vkrow8 VK_MINUS     , 0                             , "-" , "_" , NONE, NONE, NONE, NONE, NONE, 0x1F
    dw 0, 0, 8 dup 0
...
vk2wchar:
    ...
    dp vk2wchar2_7, 0x1007 ; 4 : 0x0A04
    dp vk2wchar3_8, 0x1208 ; 5 : 0x0C05
...
data export
export "KBDRU_bunch_mini.dll", KbdLayerDescriptor, "KbdLayerDescriptor"
end data
...
versioninfo version,VOS_NT_WINDOWS32,VFT_DLL,VFT2_DRV_KEYBOARD,0,1200,\
    "CompanyName","Bunch",\
    "FileDescription","Клавиатурная раскладка «Русская мини» от Bunch'а",\
    "FileVersion","0.2",\
    "InternalName","KBDRU_bunch_mini",\
    "LegalCopyright","Public domain. No rights reserved.",\
    "OriginalFilename","kbdru_bunch_mini.dll",\
    "ProductName","kbdasm",\
    "ProductVersion","1.0"
